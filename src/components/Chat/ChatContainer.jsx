...
// Re-exported for tests: ChatContainer.aliases.test.js imports extractStockSymbols
// from this file. The alias table itself now lives in lib/queryIntent.js.
// eslint-disable-next-line react-refresh/only-export-components
export { extractStockSymbols };
...
const ChatContainer = ({ sidebarOpen, routeChatId }) => {
    ...
    return (
        ...
        <div
            className={`flex flex-col h-full relative transition-[padding] duration-[280ms] ${
                scannerDrawer ? (scannerCollapsed ? 'md:pr-12' : 'md:pr-[300px]') : ''
            }`}
        >
            {chatLoadError && (
